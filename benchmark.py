...
for i in range(5):
    requests.post("http://localhost:8000/stake",json={"Sender":str(i),"Amount":1000000})

# for i in range(3):
#     requests.post("http://localhost:8000",json={"Sender":str(i+2),"Data":"abc"})

# for i in range(3):
#     requests.post("http://localhost:8000/vote",json={"Voter":str(i),"Candidates":["2","3","4"]})